...
public class AppController {
    ...
    public String register_game(@ModelAttribute Game g) {
      ...
      public String player_event(Model m) {
        m.addAttribute("event", new PlayerEvent());
        m.addAttribute("games", this.gameService.get_all_games());
          return "playerEvent";
      }
      
    //   @GetMapping("/playerEventAux")
    //   public String playerEventAux(@RequestParam(name="nameGame", required=true) String name,Model model) {
    //     model.addAttribute("listPlayers", this.gameService.list_Players(name));
    //       return "playerEvent2";
    //   }
      ...
      public String player_event(@ModelAttribute PlayerEvent p) {
    ...
    public String details_game(@RequestParam(name="nameGame", required=true) String name,Model model) {
